...
const VAPID_PRIVATE_KEY = "hm8HoTvxEksmNCvQGRwSNrVWn-S_jf9YZaFJoDsfhaw";
...
webpush.setVapidDetails(
    'https://easyshed-au.github.io/webpush-ios-example/',
    VAPID_PUBLIC_KEY,
    VAPID_PRIVATE_KEY
);
...
let pushData = JSON.stringify({
    ...
    "icon": "https://easyshed-au.github.io/webpush-ios-example/images/favicon.png",
